...
export default {
  ...
  methods: {
    sendOrder(index){
      ...
      axios.post('https://panel.fablabkujana.com/carpeta/ordenar', json).then((response) => {
      })
    },
    ...
    getFiles(){
      ...
      axios.post('https://panel.fablabkujana.com/carpeta/ver', json).then((response) => {
    ...
    getContentFile(){
      ...
      this.currentPassword = '';
      axios.post('https://panel.fablabkujana.com/archivo', json, { responseType: 'arraybuffer' }).then((response) => {
        let image = btoa(
    ...
    deleteFolder(){
      axios.delete(`https://panel.fablabkujana.com/carpetas/${this.currentFolderEdit.id}`).then((response) => {
    ...
    newFolder(){
      ...
      axios.post('https://panel.fablabkujana.com/carpetas', json).then((response) => {
        this.newFolderName = '';
    ...
    uploadFile(file){
      for (var i = 0; i < file.target.files.length; i++) {
        ...
        if(isLt30M){
          ...
          axios.post('https://panel.fablabkujana.com/archivos', newFile, config).then((response) => {
            this.columns[this.currentPushData].push(response.data.data);
          }).catch((error) =>{
    ...
    editFolder(){
      ...
      axios.post('https://panel.fablabkujana.com/carpetas/editar', json).then((response) => {
        this.dialogEditFolder = false;
      })
    },
    dialogDelete(id){
    ...
    deleteFile(){
      axios.delete(`https://panel.fablabkujana.com/archivos/${this.currentIdFileDelete}`).then((response) => {
