...
//       :size="sizeDialog"
//       v-if="currentFolderEdit"
//       :visible.sync="dialogEditFolder"
//     >
//       <el-input
//         placeholder="Cambiar nombre"
//         v-model="currentFolderEdit.nombre"
//       ></el-input>
//       <span
//         slot="footer"
//         class="dialog-footer"
...
//       >Crear carpeta</el-button>
//     </el-dialog> -->

    //
    <!-- <el-dialog
//       v-if="allow()"
//       v-loading.body="createFileLoadingDialog"
//       title="Subir Archivo"
//       :visible.sync="uploadFileDialog"
//       class="uploadFile_dialog"
//       :size="sizeDialog"
//     >
...
//           slot="tip"
//           v-show="!newFile"
//         >peso maximo de 10Mb</div>
//       </div>
//       <span
//         class="fileUploaded"
//         v-if="newFile"
//       ><i class="el-icon-document"></i>
//         <p>{{ newFile.name }}</p><i class="el-icon-upload-success el-icon-circle-check"></i>
//       </span>
//       <el-input
...
//         <el-button
//           type="text"
//           v-on:click="uploadFileDialog = false"
//         >Cancelar</el-button>
    ...
    // <div class="documents">
      // <div class="documents_header">
        // <div class="documents_header_intro">
          ...
          // <p class="documents_header_intro_desc">Podras encontrar todos los documentos rapido gracias a una excelente interfaz de busqueda y organización de archivos.</p>
          // </div>
        // <div class="documents_header_photo">
          // <img //
            src="../assets/aplication1.png" //
            alt="" //
          >
          // </div>
        // <p class="mobile_warning"><strong>Por favor para visualizar este contenido desde una pantalla mas grande</strong></p>
        // </div>
...
//               v-if="allow()"
//               type="button"
//               class="documents__action createFolder"
//               v-on:click="beforeNewFolder(column, index)"
//             ><i class="material-icons">add</i>Crear Carpeta</button>
//             <button
//               v-if="allow() && index != 0"
//               type="button"
//               class="documents__action uploadFile"
//               v-on:click="beforeUploadFile(column, index)"
//             ><i class="material-icons">cloud_upload</i>Subir Archivo<input
//                 type="file"
//                 v-on:change="uploadFile"
//                 multiple
//               ></button>
...
//       }
//       axios
//         .post("https://panel.fablabkujana.com/carpeta/ver", json)
//         .then(response => {
...
//       this.currentPassword = "";
//       axios
//         .post("https://panel.fablabkujana.com/archivo", json, {
...
//       };
//       axios
//         .post("https://panel.fablabkujana.com/carpetas", json)
//         .then(response => {
//           this.newFolderName = "";
...
//             document.getElementById(
//               "columns"
//             ).scrollLeft = document.getElementById("columns").scrollWidth;
//           }, 100);
//         })
//         .catch(error => {
//           this.createFolderDialog = false;
...
//           axios
//             .post("https://panel.fablabkujana.com/archivos", newFile, config)
//             .then(response => {
//               this.columns[this.currentPushData].push(response.data.data);
//             })
//             .catch(error => {
...
//       };
//       axios
//         .post("https://panel.fablabkujana.com/carpetas/editar", json)
//         .then(response => {
//           this.dialogEditFolder = false;
//         });
//     },
...
//       axios
//         .delete(
//           `https://panel.fablabkujana.com/archivos/${this.currentIdFileDelete}`
//         )
//         .then(response => {
//           document.getElementById(
//             `file${this.currentIdFileDelete}`
//           ).style.display = "none";
...
//   margin: 0 5px;
// }
// .documents__column .folder.selected p,
// .documents__column .folder.selected i {
//   color: #fff;
...
//   margin: 0 5px;
// }
// .documents__column .file.selected p,
